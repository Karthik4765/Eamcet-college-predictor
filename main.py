...
male_radio = tk.Radiobutton(gender_frame, text="Male", variable=gender_var, value="M")
female_radio = tk.Radiobutton(gender_frame, text="Female", variable=gender_var, value="F")
